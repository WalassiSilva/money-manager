...
import { deleteTransaction, getCategories, getTransactionById, updateTransaction } from "../../../services-api";
...
export const TransactionForm = () => {
  ...
  return (
    <main onClick={() => {if (showCalendar) setShowCalendar(!showCalendar)}}
