...
export const TransactionsCard: React.FC<TransactionsProps> = ({
  ...
  return (
    <section className="bg-gray-600 m-4 px-4 py-1 rounded-xl flex hover:shadow-white hover:translate-x-2 duration-300">
      <div className="flex items-center justify-center m-3 ml-0">
        {setIconCategory(Number(category_id))}
      </div>

      <div className="flex-1 flex justify-between ">
        <h2 className="font-bold self-center text-sm md:text-lg capitalize">
          {title}
        </h2>
